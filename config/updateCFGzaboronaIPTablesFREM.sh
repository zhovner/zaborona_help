...
#LISTLINK_ALLCONFIG="https:/raw.githubusercontent.com/zhovner/zaborona_help/master/config/ferm/whitelist.conf"
LISTLINK_ALLCONFIG="https:/raw.githubusercontent.com/zhovner/zaborona_help/master/config/ipsdb.txt"
...
FILENAMERESULT3="whitelist.conf"
FILENAMERESULT4="ipsdbFERM.txt"
...
#echo "Собираем все в один файл, чтобы за один раз прогнать все записи и не плодить много парсинга"
	...
	cp $WORKFOLDERNAME3/updateCFGzaboronaIPTablesFREM_header.txt $WORKFOLDERNAME/$FILENAMERESULT3
