...
LISTLINK_ALLCONFIG="https:/raw.githubusercontent.com/zhovner/zaborona_help/master/config/openvpn/ccd_zaborona_big_routes/DEFAULT"
#LISTLINK_ALLCONFIG="https:/raw.githubusercontent.com/zhovner/zaborona_help/master/config/ips-big_routes.txt"

WORKFOLDERNAME0="ccd_zaborona_big_routes"
WORKFOLDERNAME="/tmp"
#WORKFOLDERNAME=$PWD/result
WORKFOLDERNAME2="/etc/openvpn/ccd_zaborona_big_routes"
WORKFOLDERNAME3="$WORKFOLDERNAME/$WORKFOLDERNAME0"
WORKFOLDERNAME4=$PWD
FILENAMERESULT="ccd_zaborona_big_routes-tmp1"
FILENAMERESULT2="ccd_zaborona_big_routes-tmp2"
FILENAMERESULT3="DEFAULT"
FILENAMERESULT4="ips-big_routes.txt"
...
#do
#    C_NET="$(echo $onlyroute | awk -F '/' '{print $1}')"
#    C_NETMASK="$(sipcalc -- "$onlyroute" | awk '/Network mask/ {print $4; exit;}')"
